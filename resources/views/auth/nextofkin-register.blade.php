...
<head>
    ...
    <title>Next-of-Kin Registration</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="login-container text-center">
                    <img src="{{ asset('pictures/carehome_logo.png') }}" alt="Care Home Logo" class="logo" style="width: 150px; height: auto;">
                    <h3 class="mb-4">Next-of-Kin Registration</h3>
                    @if ($errors->any())
